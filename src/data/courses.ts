...
export const courses: Course[] = [
  ...
  { id: "27", title: "Sales, Marketing & Profit Mastery", description: "Master sales, marketing, and profit optimization for your food business.", category: "Platinum", price: price(6), image: course28, gradient: grad(8), icon: "📈", status: "Published", enrollUrl: DEFAULT_ENROLL, sections: 2, lectures: 11 },
