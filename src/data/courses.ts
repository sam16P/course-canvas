...
export const courses: Course[] = [
  ...
  { id: "25", title: "Amazing Life Workshop", description: "Transform your life and business with this comprehensive workshop.", category: "Platinum", price: price(4), image: course25, gradient: grad(6), icon: "✨", status: "Published", enrollUrl: DEFAULT_ENROLL, sections: 7, lectures: 19 },
  { id: "26", title: "Implementation Challenge", description: "Take action and implement strategies with guided challenges.", category: "Platinum", price: price(5), image: course26, gradient: grad(7), icon: "🎯", status: "Published", enrollUrl: DEFAULT_ENROLL, sections: 2, lectures: 8 },
  { id: "27", title: "Sales, Marketing & Profit Mastery", description: "Master sales, marketing, and profit optimization for your food business.", category: "Platinum", price: price(6), image: course27, gradient: grad(8), icon: "📈", status: "Published", enrollUrl: DEFAULT_ENROLL, sections: 2, lectures: 11 },
  { id: "28", title: "Team Building Challenge", description: "Build and lead high-performing teams with structured challenges.", category: "Platinum", price: price(7), image: course28, gradient: grad(0), icon: "👥", status: "Published", enrollUrl: DEFAULT_ENROLL, sections: 1, lectures: 4 },
  { id: "29", title: "OPERATION & SYSTEM CHALLENGE", description: "Streamline operations and build systems for scalable growth.", category: "Platinum", price: price(8), image: course29, gradient: grad(1), icon: "🏭", status: "Published", enrollUrl: DEFAULT_ENROLL, sections: 1, lectures: 7 },
  { id: "30", title: "FOOD BUSINESS MASTERY", description: "Complete mastery program for running a successful food business.", category: "Platinum", price: price(9), image: course30, gradient: grad(2), icon: "🍽️", status: "Published", enrollUrl: DEFAULT_ENROLL, sections: 3, lectures: 4 },
  ...
  { id: "34", title: "Franchise Creation Challenge (Platinum Bonus)", description: "Learn to create and scale a franchise model for your food business.", category: "Platinum", price: price(3), image: course34, gradient: grad(6), icon: "🏢", status: "Published", enrollUrl: DEFAULT_ENROLL, sections: 6, lectures: 24 },
  { id: "35", title: "Platinum Rise & Shine", description: "Morning motivation and strategy sessions for platinum members.", category: "Platinum", price: price(4), image: course35, gradient: grad(7), icon: "🌅", status: "Published", enrollUrl: DEFAULT_ENROLL, sections: 1, lectures: 14 },
  { id: "36", title: "Hall Of Fame Mastermind", description: "Mastermind sessions with hall of fame members sharing winning strategies.", category: "Platinum", price: price(5), image: course36, gradient: grad(8), icon: "🏅", status: "Published", enrollUrl: DEFAULT_ENROLL, sections: 1, lectures: 9 },
  { id: "37", title: "Fast Track Launch", description: "Launch your cloud kitchen business fast with step-by-step guidance.", category: "Platinum", price: price(6), image: course37, gradient: grad(0), icon: "🚀", status: "Published", enrollUrl: DEFAULT_ENROLL, sections: 10, lectures: 32 },
  { id: "38", title: "Menu Engineering Mastery", description: "Design profitable menus using data analytics and culinary creativity.", category: "Platinum", price: price(7), image: course38, gradient: grad(1), icon: "📋", status: "Published", enrollUrl: DEFAULT_ENROLL, sections: 2, lectures: 5 },
  { id: "39", title: "Smart Packaging Mastery (Platinum Bonus)", description: "Design packaging that wows customers and strengthens your brand.", category: "Platinum", price: price(8), image: course39, gradient: grad(2), icon: "📦", status: "Published", enrollUrl: DEFAULT_ENROLL, sections: 1, lectures: 4 },
  { id: "40", title: "Facebook Ad Launch Challenge (Platinum Bonus)", description: "Launch profitable Facebook ad campaigns with guided challenges.", category: "Platinum", price: price(9), image: course40, gradient: grad(3), icon: "📘", status: "Published", enrollUrl: DEFAULT_ENROLL, sections: 2, lectures: 8 },
  { id: "41", title: "Reels Mastery (Platinum Bonus)", description: "Create viral reels that boost brand visibility and drive sales.", category: "Platinum", price: price(10), image: course41, gradient: grad(4), icon: "🎬", status: "Published", enrollUrl: DEFAULT_ENROLL, sections: 4, lectures: 16 },
  { id: "42", title: "Marketing Special Masterclass", description: "Special masterclass on advanced marketing techniques for food businesses.", category: "Platinum", price: price(1), image: course42, gradient: grad(5), icon: "🎯", status: "Published", enrollUrl: DEFAULT_ENROLL, sections: 1, lectures: 1 },
  { id: "43", title: "Hall Of Fame Interviews", description: "In-depth interviews with hall of fame members sharing their journeys.", category: "Platinum", price: price(2), image: course43, gradient: grad(6), icon: "🎤", status: "Published", enrollUrl: DEFAULT_ENROLL, sections: 1, lectures: 21 },
  { id: "44", title: "Collab With Brands", description: "Learn to collaborate with brands for mutual growth and revenue.", category: "Platinum", price: price(3), image: course44, gradient: grad(7), icon: "🤝", status: "Published", enrollUrl: DEFAULT_ENROLL, sections: 1, lectures: 8 },
